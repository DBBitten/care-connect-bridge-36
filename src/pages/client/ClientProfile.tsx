          ...
          <CardContent className="p-6">
            <Tabs defaultValue="pessoais">
              <TabsList className="w-full mb-6">
                <TabsTrigger value="pessoais" className="flex-1">Informações Pessoais</TabsTrigger>
                <TabsTrigger value="idoso" className="flex-1">Informações do Idoso</TabsTrigger>
              </TabsList>
              ...
              <TabsContent value="idoso" className="space-y-4 mt-0">
                <div className="space-y-2">

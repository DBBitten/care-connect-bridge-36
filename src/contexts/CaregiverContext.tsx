...
const seedProfiles: CaregiverProfileData[] = [
  {
    ...
    languages: ["Português"],
    serviceOffers: [
      { serviceId: "svc-1", pricePerHour: 40, availableDurations: [120, 240, 480] },
      { serviceId: "svc-2", pricePerHour: 50, availableDurations: [120, 240] },
      { serviceId: "svc-3", pricePerHour: 42, availableDurations: [120, 240] },
      { serviceId: "svc-5", pricePerHour: 55, availableDurations: [120, 240, 480] },
    ],
  ...
  },
  {
    ...
    serviceOffers: [
      { serviceId: "svc-1", pricePerHour: 45, availableDurations: [120, 240] },
      { serviceId: "svc-3", pricePerHour: 48, availableDurations: [120, 240] },
      { serviceId: "svc-4", pricePerHour: 50, availableDurations: [120] },
    ],
  ...
  },
  {
    ...
    languages: ["Português"],
    serviceOffers: [
      { serviceId: "svc-1", pricePerHour: 50, availableDurations: [240, 480, 720] },
      { serviceId: "svc-2", pricePerHour: 55, availableDurations: [120, 240] },
    ],
  ...
  },
  {
    ...
    serviceOffers: [
      { serviceId: "svc-1", pricePerHour: 60, availableDurations: [120, 240] },
      { serviceId: "svc-2", pricePerHour: 65, availableDurations: [120, 240] },
      { serviceId: "svc-3", pricePerHour: 60, availableDurations: [120, 240] },
      { serviceId: "svc-4", pricePerHour: 65, availableDurations: [120] },
      { serviceId: "svc-5", pricePerHour: 70, availableDurations: [120, 240, 480] },
    ],
  ...
  },
  {
    ...
    languages: ["Português"],
    serviceOffers: [
      { serviceId: "svc-1", pricePerHour: 30, availableDurations: [120, 240] },
    ],
    certifications: [],
